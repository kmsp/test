...
export default class BaseFlatListComponent extends BaseComponent {
    ...
    renderFlatViewFooter = () => {
        ...
        if (loadMoreStatus == 0) {
            return (
                <View style={{ width: global.DEVICE.width, height: dp(130), justifyContent: 'center', alignItems: 'center' }}>
            ...
            return (
                <TouchableOpacity
                    ...
                    style={{ width: global.DEVICE.width, height: dp(130), justifyContent: 'center', alignItems: 'center' }}>

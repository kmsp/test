...
export default class TixianJiluPage extends Component{
    constructor(props){
        super(props);
    ...
    _getListDate(){
        FetchRequest(
            global.ActiveDomain+'/tixian_record',
            'post',
            {
        ...
        return(
            <MdSafeAreaView style={{flex:1,backgroundColor:'@BackgroundColor'}} forceInset={{ bottom: 'never' }}>
                <Theme.View style={[styles.navBar,{backgroundColor:'@HeadColor'}]}>
                    ...
                    <Text style={styles.navBarText}>提现明细</Text>
                </Theme.View>
                <View style={{flexDirection: 'row',paddingHorizontal:10,borderBottomColor:'#eee',borderBottomWidth: 1}}>
                    <Theme.Text style={{flex:1,lineHeight:40,color:'@TextColor'}}>申请编号</Theme.Text>
                    <Theme.Text style={{width:60,textAlign: 'center',lineHeight:40,color:'@TextColor'}}>收款人</Theme.Text>
                    <Theme.Text style={{width:40,textAlign: 'center',lineHeight:40,color:'@TextColor'}}>金额</Theme.Text>
                    <Theme.Text style={{width:50,textAlign: 'center',lineHeight:40,color:'@TextColor'}}>状态</Theme.Text>
                ...
                <FlatList
                    ...
                    renderItem={(item)=>
                        <View style={{flexDirection: 'row',paddingHorizontal:10,borderBottomColor:'#eee',borderBottomWidth: 1}}>
                            <Theme.Text style={{flex:1,lineHeight:40,fontSize:10,color:'@TextColor'}}>{item.item.num}</Theme.Text>
                            <Theme.Text style={{width:60,textAlign: 'center',lineHeight:40,color:'@TextColor'}}>{item.item.name}</Theme.Text>
                            <Theme.Text style={{width:40,textAlign: 'center',lineHeight:40,color:'@TextColor'}}>{item.item.money}</Theme.Text>
                            <Theme.Text style={{width:50,textAlign: 'center',lineHeight:40,color:'@TextColor'}}>{item.item.state === 1 ? '成功' : '待处理'}</Theme.Text>

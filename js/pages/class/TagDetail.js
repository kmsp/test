        ...
        return(
            <MdSafeAreaView style={{flex:1,backgroundColor:'@BackgroundColor'}} forceInset={{ bottom: 'never' }}>
                ...
                <View style={{flex:1}}>
                    ...
                    >
                        <AvItem tabLabel={{label:'AV'}} typeId={1} labelId={this.props.navigation.getParam('labelId')} stateId={1} {...this.props}/>
                        <MoveItem tabLabel={{label:'短片'}} typeId={2} labelId={this.props.navigation.getParam('labelId')} stateId={1} {...this.props}/>
                    </MdScrollableTabView>
                </View>
            </MdSafeAreaView>
        )

...
import {StyleSheet, View, SafeAreaView, Dimensions, TouchableOpacity, Image, Text} from 'react-native';
import AvListHot from "./AvListHot";
import Icon from "react-native-vector-icons/AntDesign";
import Theme, {createThemedComponent} from "react-native-theming";

const MdSafeAreaView = createThemedComponent(SafeAreaView);

export default class NewAvList extends Component{
    ...
    render(){
        return(
            <MdSafeAreaView style={{flex:1,backgroundColor:'@BackgroundColor'}} forceInset={{ bottom: 'never' }}>
                ...
                <AvListHot tabId={this.props.navigation.getParam('TabId')} page={0} {...this.props}/>
            </MdSafeAreaView>
        )
    }

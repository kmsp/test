 ...
 */
 ...
 const RemindSchema = {
     ...
     properties: {
         ...
         lastRemindDate: {type:'int', default: 0},
     }
 }
...
export function queryRemind() {
    return new Promise((resolve, reject) => {
      let arrays = instance.objects('Remind')
...
export function writeRemind(obj) {
    return new Promise((resolve, reject) => {
        instance.write(() => {
            instance.create('Remind', obj, true)
            resolve(true)
        })
    })
}
